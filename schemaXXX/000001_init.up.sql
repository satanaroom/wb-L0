...
(
    id          serial not null unique,
    delivery_id char(19) references orders (id) on delete cascade not null unique,
...
(
    id            serial not null unique,
    payment_id    char(19) references orders (id) on delete cascade not null unique,
...
(
    ...
    items_id char(19) references orders (id) on delete cascade not null
);
